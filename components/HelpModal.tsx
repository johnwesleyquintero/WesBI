                ...
                <div className="p-6 overflow-y-auto">
                    ...
                    <HelpSection title="The Dashboard" icon={<BarChartIcon className="w-5 h-5" />}>
                        ...
                        <ul className="list-disc list-inside pl-4 space-y-1">
                            <li><strong>Stat Cards:</strong> Key performance indicators (KPIs) like Inventory Value and Capital at Risk are displayed at the top.</li>
                    ...
                    <HelpSection title="AI Strategy Session" icon={<SparklesIcon className="w-5 h-5" />}>
                        ...
                        <ul className="list-disc list-inside pl-4 space-y-1">
                            <li>Click the <strong>"AI Strategy"</strong> button.</li>
